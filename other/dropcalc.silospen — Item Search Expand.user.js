...
// @downloadURL https://update.greasyfork.org/scripts/576233/dropcalcsilospen%20%E2%80%94%20Item%20Search%20Expand.user.js
// @updateURL https://update.greasyfork.org/scripts/576233/dropcalcsilospen%20%E2%80%94%20Item%20Search%20Expand.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    function buildCombo(sel) {
        ...
        input.addEventListener('keydown', (e) => {
            if (e.key === 'ArrowDown') {
                ...
                document.getElementById('find')?.click();// 自動按下「尋找」
