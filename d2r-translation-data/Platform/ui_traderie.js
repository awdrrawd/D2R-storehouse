...
window.D2R_UI_TRADERIC = {
    ...
    "Your listing has been submitted!":                "您的商品已提交！",
    "Thanks for using Traderie!":                      "感謝您使用 Traderie！",
    "Add Another":                                     "添加其他商品",
    "Yes":                                             "確定",
    "OK":                                              "確定",
    "Are you sure you want to remove this listing?":   "您確定要刪除此清單嗎？",
    "local time":                                      "當地時間",
    "Are you sure you want to mark this listing as sold?":"您確定要將此商品標記為已售出嗎？",
    // == complete trade ==
    "Complete":          "完成",
    ...
    "Click here to sign up, manage, or cancel your Akrew Pro subscription.":"點擊此處註冊、管理或取消 Akrew Pro 訂閱。", //無效
    ...
    "🛡️When logging in you'll need to provide an extra login code after your password.":"🛡️登入時，除了密碼之外，您還需要輸入一個額外的登入驗證碼。",
    "📱Your login code will be generated by an app.":"📱您的登入驗證碼將由應用程式產生。",
    "✅ Once you enter your login code, we'll know it's really you!":"✅一旦您輸入登入驗證碼，我們就能確認是您本人登入！",
